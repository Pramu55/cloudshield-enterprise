...
export default function RecommendationsPage() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 inline-flex items-center gap-2 rounded border border-amber-300 bg-amber-50 px-3 py-2 text-xs font-semibold text-amber-800">
      ...
      {!data?.items.length ? (
        ...
        <div className="space-y-3">
          {data.items.map((recommendation) => {
            let modeTag = "Future";
            if (recommendation.actionType === "MANUAL_REVIEW") modeTag = "Manual";
            else if (recommendation.actionType === "GOVERNANCE_WORKFLOW") modeTag = "Review-only";
