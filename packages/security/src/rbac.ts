...
export function resolveCurrentUserCapabilities(role: string): CurrentUserCapabilities {
  ...
  return {
    [PERMISSIONS.ORGANIZATION_READ]: hasPermission(role, PERMISSIONS.ORGANIZATION_READ),
    [PERMISSIONS.ORGANIZATION_UPDATE]: hasPermission(role, PERMISSIONS.ORGANIZATION_UPDATE),
    ...
    [PERMISSIONS.INVITATIONS_READ]: hasPermission(role, PERMISSIONS.INVITATIONS_READ),
    [PERMISSIONS.INVITATIONS_CREATE]: hasPermission(role, PERMISSIONS.INVITATIONS_CREATE),
    [PERMISSIONS.INVITATIONS_RESEND]: hasPermission(role, PERMISSIONS.INVITATIONS_RESEND),
    [PERMISSIONS.INVITATIONS_REVOKE]: hasPermission(role, PERMISSIONS.INVITATIONS_REVOKE),
    ...
    [PERMISSIONS.MEMBERS_STATUS_UPDATE]: hasPermission(role, PERMISSIONS.MEMBERS_STATUS_UPDATE),
    [PERMISSIONS.FINDINGS_READ]: hasPermission(role, PERMISSIONS.FINDINGS_READ),
    [PERMISSIONS.FINDINGS_MANAGE]: hasPermission(role, PERMISSIONS.FINDINGS_MANAGE),
    [PERMISSIONS.RISKS_READ]: hasPermission(role, PERMISSIONS.RISKS_READ),
    [PERMISSIONS.RISKS_MANAGE]: hasPermission(role, PERMISSIONS.RISKS_MANAGE),
    [PERMISSIONS.RISK_ACCEPT]: hasPermission(role, PERMISSIONS.RISK_ACCEPT),
    ...
    [PERMISSIONS.REPORTS_READ]: hasPermission(role, PERMISSIONS.REPORTS_READ),
    [PERMISSIONS.REPORTS_GENERATE]: hasPermission(role, PERMISSIONS.REPORTS_GENERATE),
    [PERMISSIONS.AUDIT_READ]: hasPermission(role, PERMISSIONS.AUDIT_READ),
    [PERMISSIONS.SETTINGS_READ]: hasPermission(role, PERMISSIONS.SETTINGS_READ),
    [PERMISSIONS.SETTINGS_UPDATE]: hasPermission(role, PERMISSIONS.SETTINGS_UPDATE),
